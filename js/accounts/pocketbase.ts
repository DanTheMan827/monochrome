        ...
        if (user) {
            ...
            try {
                ...
                if (cloudData) {
                    ...
                    const localData = {
                        tracks: ((await database.getAll('favorites_tracks')) || []) as any[],
                        albums: ((await database.getAll('favorites_albums')) || []) as any[],
                        artists: ((await database.getAll('favorites_artists')) || []) as any[],
                        playlists: ((await database.getAll('favorites_playlists')) || []) as any[],
                        mixes: ((await database.getAll('favorites_mixes')) || []) as any[],
                        history: ((await database.getAll('history_tracks')) || []) as any[],
                        userPlaylists: ((await database.getAll('user_playlists')) || []) as any[],
                        userFolders: ((await database.getAll('user_folders')) || []) as any[],
                    };
                    ...
                    const combinedHistory = [...(history as any[]), ...localData.history];
