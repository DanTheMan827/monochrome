...
export const fontSettings = {
    ...
    getUploadedFontList() {
        ...
        return Object.entries(fonts).map(([id, font]) => ({
            id,
            name: (font as { name: string; size: number; uploadedAt: string }).name,
            size: (font as { name: string; size: number; uploadedAt: string }).size,
            uploadedAt: (font as { name: string; size: number; uploadedAt: string }).uploadedAt,
        }));
    },
};
