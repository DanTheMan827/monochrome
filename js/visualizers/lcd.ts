export class LCDPreset {
    ...
    draw(ctx: CanvasRenderingContext2D, canvas: HTMLCanvasElement, analyser: AnalyserNode, dataArray: Uint8Array, params: { kick: number; primaryColor: string; mode: string }): void {
