export class DashDownloader {
    ...
    async downloadDashStream(manifestBlobUrl: string, options: { onProgress?: (progress: { stage: string; receivedBytes: number; totalBytes: undefined; currentSegment: number; totalSegments: number }) => void; signal?: AbortSignal } = {}) {
