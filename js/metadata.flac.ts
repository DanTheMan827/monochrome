...
interface FlacBlocks extends Array<FlacBlock> {
    audioDataOffset?: number;
}

export function parseFlacBlocks(dataView: DataView): FlacBlocks {
    const blocks: FlacBlocks = [] as unknown as FlacBlocks;
