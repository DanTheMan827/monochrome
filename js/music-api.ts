...
export class MusicAPI {
    ...
    qobuzAPI: any;
    _settings: any;
    videoArtworkCache: Map<string, any>;
    ...
    async searchVideos(query: any, options: any = {}) {
        const provider = options.provider || this.getCurrentProvider();
